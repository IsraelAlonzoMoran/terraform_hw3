...
resource "aws_internet_gateway" "terraform-internet-gw" {
  ...
  tags = {
    "Name" = "${var.passingstring}-terraform-internet-gw"
  }
}
...
resource "aws_subnet" "terraform-public-subnet-1" {
  ...
  tags = {
    "Name" = "${var.passingstring}-terraform-public-subnet-1"
  }
}
...
resource "aws_subnet" "terraform-public-subnet-2" {
  ...
  tags = {
    "Name" = "${var.passingstring}-terraform-public-subnet-2"
  }
}
...
resource "aws_subnet" "terraform-public-subnet-3" {
  ...
  tags = {
    "Name" = "${var.passingstring}-terraform-public-subnet-3"
  }
}
...
resource "aws_subnet" "terraform-private-subnet-1" {
  ...
  tags = {
    "Name" = "${var.passingstring}-terraform-private-subnet-1"
  }
}
...
resource "aws_subnet" "terraform-private-subnet-2" {
  ...
  tags = {
    "Name" = "${var.passingstring}-terraform-private-subnet-2"
  }
}
...
resource "aws_subnet" "terraform-private-subnet-3" {
  ...
  tags = {
    "Name" = "${var.passingstring}-terraform-private-subnet-3"
  }
}
...
resource "aws_route_table" "terraform-public-route-table-1" {
  ...
  tags = {
    Name = "${var.passingstring}-terraform-public-route-table-1"
  }
}
...
resource "aws_eip" "terraform-eip-for-nat-gw" {
  vpc = true
  tags = {
    "Name" = "${var.passingstring}-terraform-eip-for-nat-gw"
  }
}
...
resource "aws_nat_gateway" "terraform-nat-gw" {
  ...
  tags = {
      "Name" = "${var.passingstring}-terraform-nat-gw"
    }
  }
...
resource "aws_route_table" "terraform-private-route-table-1" {
  ...
  tags = {
    Name = "${var.passingstring}-terraform-private-route-table-1"
  }
}
